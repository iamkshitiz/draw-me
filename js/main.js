...
function prepareSimpleSizesCanvas()
{
	...
	$('#canvasSimpleSizes')[0].addEventListener("touchstart", function (e) {
		mousePos = getTouchPos(canvas_simpleSizes, e);
		var touch = e.touches[0];
		var mouseEvent = new MouseEvent("mousedown", {
			clientX: touch.clientX,
			clientY: touch.clientY
		});
		$('#canvasSimpleSizes')[0].dispatchEvent(mouseEvent);
	}, false);

	$('#canvasSimpleSizes')[0].addEventListener("touchend", function (e) {
		var mouseEvent = new MouseEvent("mouseup", {});
		$('#canvasSimpleSizes')[0].dispatchEvent(mouseEvent);
	}, false);
	$('#canvasSimpleSizes')[0].addEventListener("touchmove", function (e) {
		var touch = e.touches[0];
	...
	{
		var dataURL = canvas_simpleSizes.toDataURL();
